...
export const FloatButtons = () => {
  ...
  const popoverContent = (
    <div className={"popover-content"}>
      <Paragraph>
        Загрузите отчёт брокера Interactive Brokers в формате CSV на английском
        языке по кнопке загрузить отчёт, данный сервис просканирует ваш отчёт и
        отобразит все полученные вами дивиденды и сделает необходимые расчеты
        для налоговой
      </Paragraph>
      <Paragraph>
